...
Pembagian izin (modul `internal_request`):
  ...
  * `convert` — admin · manajer · **sales_admin** (FASE E-8; dibetulkan T2 audit 2026-06)
"""
...
#: Peran yang MENINDAK permintaan (melihat semua permintaan entitas aktif, memilih
#: sumber, menolak/mengonversi). T2 audit training 2026-06: `sales_admin` dulu
#: tertinggal di sini padahal matriks izin & antrean Meja Admin Sales sudah
#: memberinya `convert` — layarnya kosong & /sources 403 (jalan buntu).
CROSS_ENTITY_ROLES = ("admin", "manager", "sales_admin")
DECIDER_ROLES = ("admin", "manager", "sales_admin")
