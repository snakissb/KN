...
def test_D1_pagar_home_kpi_tidak_bisa_dimatikan(loop):
    ...
    # Sesi 4 (2026-09): `manager` kini ikut BOARD_ROLES (papan PO custom wajib ada di
    # beranda manajer sejak 2026-06) → payload tanpa papan juga DITUDUH. Asersi "== 0" basi.
    assert n_mgr > 0, f"payload manager tanpa special_orders_waiting TIDAK dituduh: {res_mgr}"
