...
async def assert_ready_to_confirm(order: Dict[str, Any]) -> None:
    """Gerbang verifikasi sebelum Konfirmasi SO (config, bawaan HIDUP sejak audit
    training 2026-06 · T1 — dokumen training menjanjikan gerbang ini).

    Pemilik tetap bisa mematikannya di Pusat Pengaturan → Persetujuan & Ambang
    kapan pun tanpa deploy (per badan usaha atau global).
    """
