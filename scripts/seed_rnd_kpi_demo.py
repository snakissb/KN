...
async def seed(verbose: bool = True) -> int:
    ...
    made += 1
    # MD-05: proofing hanya foto + catatan (tanpa hasil ukur); labdip tetap ber-kolom ukur.
    await _round(c["id"], s1["id"], actor=BAGAS,
                 note="Hasil cetak buram, garis motif pecah di beberapa bagian.",
                 meas={} if design else {"delta_e": 4.2, "colorfastness_wash": 3, "colorfastness_rub": 3},
    ...
    await _round(c["id"], s2["id"], actor=BAGAS,
                 ...
                 meas={} if design else {"delta_e": 2.6, "colorfastness_wash": 4, "colorfastness_rub": 4},
