...
- **Waktu:** 2026-09-06 07:14:57
- **Mode:** `quick`  ·  **Durasi total:** 52s  ·  **Pekerja statik:** 2
...
| validate_compliance (file/naming/docs/api/env) | PASS (3s) |
...
| guard:list_export (INV-UI-07, daftar berhalaman wajib bisa diunduh) | PASS (4s) |
| guard:detail_modal SELF-TEST (bukti-merah + anti tuduh palsu) | PASS (0s) |
| guard:detail_modal (INV-UI-08, panel rincian wajib pop-up) | PASS (7s) |
| guard:picker_portal SELF-TEST (bukti-merah + anti tuduh palsu, 16 kasus) | PASS (22s) |
| guard:picker_portal (INV-UI-09, pemilih wajib ber-portal · pop-up bukan anak <label>) | PASS (22s) |
...
| guard:codebase_map SELF-TEST (bukti-merah dua arah, 6 kasus) | PASS (4s) |
...
| guard:notif_audience (INV-NOTIF-02, alamat notifikasi dari WEWENANG) | PASS (2s) |
