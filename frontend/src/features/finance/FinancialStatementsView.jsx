        ...
        {mode === "range" ? (
          <div className="flex flex-wrap items-end gap-3">
            <Labeled label="Dari Tanggal">
              <KNDatePicker data-testid="fs-pl-start" className="w-[170px] text-[12px]" clearable={false} value={range.start}
                onChange={(v) => setRange((r) => ({ ...r, start: v }))} />
            </Labeled>
            <Labeled label="Sampai Tanggal">
              <KNDatePicker data-testid="fs-pl-end" className="w-[170px] text-[12px]" clearable={false} min={range.start} value={range.end}
      ...
      <div className="rounded-lg border border-[#EFF0F2] p-3 mb-3 bg-[#FCFCFD]">
        <div className="flex flex-wrap items-end gap-3">
          <Labeled label="Posisi Per Tanggal">
            <KNDatePicker data-testid="fs-bs-asof" className="w-[170px] text-[12px]" clearable={false} value={asOf}
              onChange={setAsOf} />
          </Labeled>
          ...
          {comparative && (
            <Labeled label="Pembanding Per Tanggal">
              <KNDatePicker data-testid="fs-bs-compare-asof" className="w-[170px] text-[12px]" clearable={false} value={compareAsOf}
