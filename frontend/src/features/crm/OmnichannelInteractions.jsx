...
import KNDateTimePicker from "@/components/KNDateTimePicker";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4" data-testid="intx-modal">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-lg max-h-[90vh] flex flex-col">
        ...
        <div className="p-4 space-y-3 overflow-y-auto">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Field label="Waktu Interaksi"><KNDateTimePicker data-testid="intx-form-occurred" clearable={false} value={form.occurred_at} onChange={(v) => set("occurred_at", v)} /></Field>
            <Field label="Tindak Lanjut (opsional)"><KNDateTimePicker data-testid="intx-form-followup" value={form.follow_up_date} onChange={(v) => set("follow_up_date", v)} /></Field>
          </div>
        </div>
