          ...
          <div className="px-5 py-4 space-y-3">
            ...
            {tab === "shift" && (<>
              <div className="grid grid-cols-2 gap-3">
                <Field label="Jam Masuk"><KNTimePicker data-testid="setup-jam-in" clearable={false} value={form.jam_in} onChange={(v) => set("jam_in", v)} /></Field>
                <Field label="Jam Keluar"><KNTimePicker data-testid="setup-jam-out" clearable={false} value={form.jam_out} onChange={(v) => set("jam_out", v)} /></Field>
