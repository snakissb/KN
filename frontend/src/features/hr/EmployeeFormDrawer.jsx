          ...
          <Section title="Data Pribadi">
            <div className="grid grid-cols-2 gap-3">
              ...
              <Field label="Tanggal Lahir">
                <KNDatePicker data-testid="employee-dob-input" value={form.dob} onChange={(v) => set("dob", v)} placeholder="Tanggal lahir" />
              </Field>
              <Field label="Telepon">
          ...
          <Section title="Kepegawaian">
            <div className="grid grid-cols-2 gap-3">
              ...
              <Field label="Tanggal Masuk">
                <KNDatePicker data-testid="employee-joindate-input" value={form.join_date} onChange={(v) => set("join_date", v)} placeholder="Tanggal bergabung" />
              </Field>
              <Field label="Status">
